    ...
    <Helmet title="Home">
      ...
      <section className="why_choose-us">
        <Container>
          <Row>
            <Col lg="6" md="6">
              <img src={whyImg} alt="why-food-deed" className="w-100" />
            </Col>

            <Col lg="6" md="6">
              <div className="why_food-deed">
                <h2 className="food_deed-title mb-4">
                  Why <span>Food Deed?</span>
                </h2>
                <p className="food_deed-desc">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
